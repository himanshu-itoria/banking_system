...
//             double withdraw(double bal, double amount)
//             {
...
// void send_receive(string sender,string receiver, double amount)
// {   Transactions td;
//         double a = td.withdraw(acc_details[sender],amount);
//         acc_details[receiver] = td.withdraw(acc_details[receiver],amount);
